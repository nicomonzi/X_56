...
#define MAVLINK_MSG_ID_EYE_TRACKING_DATA 24405
...
#define MAVLINK_MSG_ID_EYE_TRACKING_DATA_LEN 49
#define MAVLINK_MSG_ID_EYE_TRACKING_DATA_MIN_LEN 49
#define MAVLINK_MSG_ID_24405_LEN 49
#define MAVLINK_MSG_ID_24405_MIN_LEN 49

#define MAVLINK_MSG_ID_EYE_TRACKING_DATA_CRC 121
#define MAVLINK_MSG_ID_24405_CRC 121
...
#define MAVLINK_MESSAGE_INFO_EYE_TRACKING_DATA { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_eye_tracking_data_t, time_usec) }, \
         ...
         { "surface_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 48, offsetof(mavlink_eye_tracking_data_t, surface_id) }, \
...
static inline uint16_t mavlink_msg_eye_tracking_data_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, float gaze_origin_x, float gaze_origin_y, float gaze_origin_z, float gaze_direction_x, float gaze_direction_y, float gaze_direction_z, float video_gaze_x, float video_gaze_y, uint8_t surface_id, float surface_gaze_x, float surface_gaze_y)
{
    ...
    _mav_put_uint8_t(buf, 48, surface_id);
...
{
    return mavlink_msg_eye_tracking_data_pack_chan(system_id, component_id, chan, msg, eye_tracking_data->time_usec, eye_tracking_data->gaze_origin_x, eye_tracking_data->gaze_origin_y, eye_tracking_data->gaze_origin_z, eye_tracking_data->gaze_direction_x, eye_tracking_data->gaze_direction_y, eye_tracking_data->gaze_direction_z, eye_tracking_data->video_gaze_x, eye_tracking_data->video_gaze_y, eye_tracking_data->surface_id, eye_tracking_data->surface_gaze_x, eye_tracking_data->surface_gaze_y);
}
...
{
    return mavlink_msg_eye_tracking_data_pack_status(system_id, component_id, _status, msg,  eye_tracking_data->time_usec, eye_tracking_data->gaze_origin_x, eye_tracking_data->gaze_origin_y, eye_tracking_data->gaze_origin_z, eye_tracking_data->gaze_direction_x, eye_tracking_data->gaze_direction_y, eye_tracking_data->gaze_direction_z, eye_tracking_data->video_gaze_x, eye_tracking_data->video_gaze_y, eye_tracking_data->surface_id, eye_tracking_data->surface_gaze_x, eye_tracking_data->surface_gaze_y);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_eye_tracking_data_send(chan, eye_tracking_data->time_usec, eye_tracking_data->gaze_origin_x, eye_tracking_data->gaze_origin_y, eye_tracking_data->gaze_origin_z, eye_tracking_data->gaze_direction_x, eye_tracking_data->gaze_direction_y, eye_tracking_data->gaze_direction_z, eye_tracking_data->video_gaze_x, eye_tracking_data->video_gaze_y, eye_tracking_data->surface_id, eye_tracking_data->surface_gaze_x, eye_tracking_data->surface_gaze_y);
#else
 ...
 */
static inline void mavlink_msg_eye_tracking_data_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, float gaze_origin_x, float gaze_origin_y, float gaze_origin_z, float gaze_direction_x, float gaze_direction_y, float gaze_direction_z, float video_gaze_x, float video_gaze_y, uint8_t surface_id, float surface_gaze_x, float surface_gaze_y)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
