...
#define MAVLINK_MARSH_XML_HASH -1747103774266901764
...
/** @brief Component ids (values) for different nodes of the simulator network (flight model, controls, visualisation etc.). Components will always receive messages from the Manager relevant for their ID. Only the first component in a network with a given system ID and component ID will have its messages forwarded by the Manager, all other ones will only be treated as output (will be shadowed). This enum is a redefinition of MAV_COMP_ID_USER# messages from MAV_COMPONENT documented at https://mavlink.io/en/messages/common.html#MAV_COMPONENT */
#ifndef HAVE_ENUM_MARSH_COMPONENT
#define HAVE_ENUM_MARSH_COMPONENT
typedef enum MARSH_COMPONENT
{
   MARSH_COMP_ID_MANAGER=25, /* The simulation manager responsible for routing packets between different nodes. Typically MARSH Manager, see https://marsh-sim.github.io/manager.html | */
   MARSH_COMP_ID_FLIGHT_MODEL=26, /* Component simulating flight dynamics of the aircraft. | */
   MARSH_COMP_ID_CONTROLS=27, /* Component providing pilot control inputs. | */
   MARSH_COMP_ID_VISUALISATION=28, /* Component showing the visual situation to the pilot. | */
   MARSH_COMP_ID_INSTRUMENTS=29, /* Component implementing pilot instrument panel. | */
   MARSH_COMP_ID_MOTION_PLATFORM=30, /* Component that moves the entire cockpit for motion cueing. | */
   MARSH_COMP_ID_GSEAT=31, /* Component for in-seat motion cueing. | */
   MARSH_COMP_ID_EYE_TRACKER=32, /* Component providing gaze data of pilot eyes. | */
   MARSH_COMP_ID_CONTROL_LOADING=33, /* Component measuring and actuating forces on pilot control inputs. | */
...
/** @brief Error codes specific to eMotion Motion System from Bosch Rexroth. Details described in GENERIC-02-30-7100-IML-0700 document. */
#ifndef HAVE_ENUM_REXROTH_MOTION_PLATFORM_ERROR
#define HAVE_ENUM_REXROTH_MOTION_PLATFORM_ERROR
typedef enum REXROTH_MOTION_PLATFORM_ERROR
{
   REXROTH_ERR_OK=0, /* No error. | */
